               ...
               // final AlertDialog.Builder dialog = new AlertDialog.Builder(ContactInfo.this);
                ...
                dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Backendless.Persistence.of(Contact.class).remove(ApplicationClass.contacts.get(index), //removing it from the backend
                                new AsyncCallback<Long>() {
                                    @Override
                                    public void handleResponse(Long response) {
                                        ApplicationClass.contacts.remove(index); // removing it from the phone
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              else
              {
                  ...
                  showProgress(true);
                  tvLoad.setText("Uploading contact...Please wait...");
